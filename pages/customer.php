        ...
        <div class="row">
            ...
            <div class="col-md-10 col-lg-9 col-xl-10" id="topofmenuPd">
                <div class="col-md-12 bigBox">
                    <div class="h3" data-aos="fade-up" data-aos-delay="800">Customer
                        <hr>
                    </div>


                    <?php
                    $se = $coon->prepare("SELECT * FROM customer ");
                    $se->execute();
                    ...
                    <div class="mainCustomer  text-center" data-aos="flip-up" data-aos-delay="800">
                        <img src="../images/customer/<?= $row["cus_img"] ?>" alt="" srcset="">
                    </div>
